...
namespace ChernabogJailApp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public RegisterConfirmationModel(UserManager<ChernabogJailAppUser> userManager, IEmailService sender)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string returnUrl = null)
        {
            ...
            if (user == null)
            {
                return NotFound($"Невозможно найти пользователя с таким почтовым адресом: '{email}'.");
            }
