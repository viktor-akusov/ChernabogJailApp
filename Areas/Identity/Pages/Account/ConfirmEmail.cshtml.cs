...
namespace ChernabogJailApp.Areas.Identity.Pages.Account
{
    public class ConfirmEmailModel : PageModel
    {
        ...
        public ConfirmEmailModel(UserManager<ChernabogJailAppUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string code)
        {
            ...
            StatusMessage = result.Succeeded ? "Ваш аккаунт подтвержден. Войдите в него, используя свои логин и пароль." : "Ошибка подтверждения.";
            return Page();
        }
    }
}
